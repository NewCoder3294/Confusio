    ...
    <div className="flex-1 flex items-center justify-center p-6">
      <div className="max-w-2xl border border-fail-border bg-fail-bg/40 p-6 flex flex-col gap-4">
        <div>
          ...
          <p className="mt-2 text-[12px] text-fg-muted leading-6">
        ...
        <div className="border border-border-subtle bg-bg-base p-3 font-mono text-[11px] text-fg-mono whitespace-pre-wrap break-all">
